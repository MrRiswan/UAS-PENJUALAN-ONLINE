...
<form method="post" enctype="multipart/from-data">
	<div class="form-group">
		...
		<input type="text" name="nama" class="from-control" value="<?php echo $pecah['nama_produk']; ?>">
	</div>	
	<div class="form-group">
	...
	<div class="form-group">
		...
		<textarea name="deskripsi" class="from-control" rows="10"> <?php echo $pecah ['deskripsi_produk']; ?></textarea>
	</div>
